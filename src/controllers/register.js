...
const register = {
    ...
    try {
      ...
      if (
        ...
        sendQuery = await pool.query(
          `INSERT INTO employee (firstName, lastName, email, password, gender, jobRole, department, address)
  ...
  async logIn(req, res) {
    ...
    try {
      ...
      sendQuery = await pool.query('SELECT * FROM employee WHERE email=$1', [
        email,
      ]);
      ...
      bcrypt.compare(password, data.password, (err, result) => {
        ...
        // incorrect email and password
          ...
          jsonResponse(
            ...
            'error',
            403,
            'token not generated, incorrect email or password'
          );
        }
      });
    } catch (e) {
